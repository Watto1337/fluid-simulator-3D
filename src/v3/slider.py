...
class Slider():
    ...
    def draw(self, display, mousePos, mouseDown):
        ...
        draw.line(display, self.color, self.pos, (self.pos[0] + self.width, self.pos[1]), 2)
        draw.circle(display, self.color, (self.pos[0] + self.width * (self.n - self.min) / (self.max - self.min), self.pos[1]), 5)
